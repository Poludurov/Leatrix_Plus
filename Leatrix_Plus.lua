...
function LeaPlusLC:ReloadCheck()
    ...
    if (LeaPlusLC["UseEasyChatResizing"] ~= LeaPlusDB["UseEasyChatResizing"])    -- Use easy resizing
            ...
            or (LeaPlusLC["ImprovedLootFrame"] ~= LeaPlusDB["ImprovedLootFrame"])            -- ImprovedLootFrame
...
local function eventHandler(self, event, arg1, arg2, ...)
    ...
    if event == "ADDON_LOADED" then
        if arg1 == "Leatrix_Plus" then
            ...
            LeaPlusLC:LoadVarChk("ImprovedLootFrame", "Off")                    -- ImprovedLootFrame
    ...
    if event == "PLAYER_LOGOUT" then
        ...
        LeaPlusDB["ImprovedLootFrame"] = LeaPlusLC["ImprovedLootFrame"]
...
function LeaPlusLC:SlashFunc(str)
    if str and str ~= "" then
        ...
        elseif str == "admin" then
            ...
            LeaPlusDB["ImprovedLootFrame"] = "On"                    -- ImprovedLootFrame
...
LeaPlusLC:MakeCB(LeaPlusLC[pg], "ImprovedLootFrame", "Enhance loot frame", 146, -212, true, "If checked, condenses all loot onto one page when using the Blizzard default loot frame.", "Improves master looter dropdown menu.")
